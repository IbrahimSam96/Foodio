...
const MyAccount = ({ uid }) => {
    ...
    return (
        <div className={`h-full min-h-screen w-full grid grid-cols-[repeat(7,1fr)] grid-rows-[64px,auto,250px] bg-[#FFFFFF]`}>
            ...
            <div className={`bg-[#FFFFFF] mx-2 fixed w-full z-30 col-start-1 col-end-8 grid grid-cols-[60px,160px,auto,auto,auto,150px] sm:grid-cols-[60px,160px,160px,160px,auto,150px] shadow shadow-slate-300 max-h-[64px]`}>
                ...
                <span onClick={() => router.push('/plans')} className={`hidden sm:block p-[22px] self-center justify-self-center hover:bg-[#D2F895] hover:cursor-pointer group`}>
                ...
                {uid &&
                    <span className={`col-start-6 mx-2 self-center justify-self-center hover:cursor-pointer group`}>
                        ...
                        <svg className={`inline rotate-0 group-hover:rotate-180 ease-in-out	duration-300 text-black`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" color="inherit"><path fillRule="evenodd" clipRule="evenodd" d="m12 16.333-6-6L7.333 9 12 13.667 16.667 9 18 10.333l-6 6Z"
            ...
            {view == 'activeOrders' &&
                <>
                    {loading &&
                        <span className={`col-start-1 col-end-8 row-start-2 grid justify-self-center self-center m-0 sm:m-8`}>
                            <AutorenewIcon className={`text-[200px] text-green-500 animate-spin`} />
                        </span>
                    }
                    <div className={`col-start-1 col-end-8 row-start-2 grid justify-self-center self-center m-0 sm:m-8`}>
                            ...
                            return (
                                <span key={activeOrder.id} className={`justify-self-start self-center grid bg-[#F8F8F8] rounded p-1 m-2`}>
                                    ...
                                    <span className={`flex justify-self-center self-center justify-start flex-wrap max-w-[1200px] `}>
                                        ...
                                        {activeOrder.selectedReicpes && activeOrder.selectedReicpes.map((recipe) => {
                                            return (
