...
const Plans = () => {
  ...
  return (
    <div className={` h-full min-h-screen w-full grid grid-cols-[repeat(7,1fr)] grid-rows-[80px,auto,350px] bg-[white]`}>
      ...
      <div className={`bg-[#EAE6DF] mx-2 fixed w-full z-30 col-start-1 col-end-8 grid grid-cols-[60px,1fr,150px] max-h-[60px] shadow shadow-lime-300 `}>
        ...
        <Stepper className={`justify-self-center`} alternativeLabel activeStep={activeStep} connector={<ColorlibConnector />}>
          {steps.map((label, index) => {
            ...
            return (
              < Step key={label} >
                <StepLabel className={`mx-4 `} onClick={() => {
      ...
      <div className={`col-start-1 col-end-8 row-start-2 row-end-3 justify-self-center self-center grid `} >

        <p className={` text-[1.5em] font-medium font-serif text-[rgb(36,36,36)] p-3 mx-auto`}>Choose your plan size
        </p>

        <p className={` text-[0.8em] font-medium font-serif text-[rgb(36,36,36)] py-4 mx-auto`}>
        ...
        <span className={`self-center grid grid-rows-1 `}>
          ...
          <span className={`self-center row-start-1 col-start-1`}>
            <p className={` text-[0.8em] font-medium font-serif text-[rgb(36,36,36)] `}>
              Number of people
            </p>
          </span>
          ...
          <span className={`flex ml-auto row-start-1 col-start-2 `}>
            <span
              onClick={() => { }}
              className={`py-2 px-14 transition-[margin] ${numberOfPeople == 2 ? `mr-[122PX]` : `mr-0`} border-[1px] border-[green]  bg-[#056835] `}>
              <p className={`text-[white] text-sm font-bold inline`}>
              {numberOfPeople}
        ...
        <span className={`self-center grid grid-rows-1 py-4 `}>
          ...
          <span className={`flex ml-auto row-start-1 col-start-2 `}>
            <span
              onClick={() => { }}
              className={`transition-[margin] py-2 px-[35.8px] ${numberOfRecipes == 3 ? `mr-[162px]` : numberOfRecipes == 4 ? `mr-[81px] `:`mr-0`} border-[1px] border-[green]  bg-[#056835] `}>
              <p className={`text-[white] text-sm font-bold inline`}>
              {numberOfRecipes}
