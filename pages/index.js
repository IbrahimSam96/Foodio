...
const Home = () => {
  ...
  return (
    <div className={` h-full min-h-screen w-full grid grid-cols-[repeat(7,1fr)] grid-rows-[64px,650px,auto,auto,auto,350PX,250px] bg-[#ffffff]`}>
      ...
      <div className={`col-start-1 col-end-8 row-start-5 row-end-6 grid justify-self-center self-center my-2`}>
      ...
      <div className={`col-start-1 col-end-8 row-start-7 row-end-8 grid bg-[#FFFFFF] grid-cols-[repeat(7,1fr)]`}>
